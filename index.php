...
<head>
    ...
    <title>Rs.Permata Keluarga</title>
        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="badge custom-badge red pull-right"></span>Rumah Sakit Kami <b class="caret"></b></a>
				  <ul class="dropdown-menu">
				    <li><a href="index.html">RSPK Jababeka</a></li>
					<li><a href="index-form.html">RSPK Lippo Cikarang</a></li>
					<li><a href="index-video.html">RSPK Galuhmas Karawang</a></li>
				  </ul>
				</li>
				<li><a href="#service">Service</a></li>
				<li><a href="#doctor">Doctors</a></li>
				<li><a href="#facilities">Fasilitas Pelayanan</a></li>
				<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="badge custom-badge red pull-right"></span>Jadwal Dokter <b class="caret"></b></a>
				  <ul class="dropdown-menu">
				    <li><a href="index.html">RSPK Jababeka</a></li>
					<li><a href="index.html">RSPK Lippo Cikarang</a></li>
					<li><a href="index.html">RSPK Galuhmas Karawang</a></li>
				  </ul>
				</li>
				<li><a href="#service">Lowongan Kerja</a></li>
			  </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
